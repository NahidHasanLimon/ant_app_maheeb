...
class EmployeeController extends Controller
{
    ...
    public function index(){
        ...
        $items = User::all();
        return view('admin.pages.add_employee',compact('items'));
    }
...
//        $user->personal_email = "approved_4";
...
//            $path = public_path() . '/backend/img/user_photo';
            $upload_path='backend/img/user_photo/';
            $name = sha1(date('YmdHis') . Str::random(30));
            $save_name = $name . '.' . $file->getClientOriginalExtension();
            $file->move($upload_path, $save_name );
...
//            $path = public_path() . '/backend/img/user_photo';
            $upload_path='backend/img/id_photo/';
...
//            $path = public_path() . '/backend/img/user_photo';
            ...
            $user->update();
            // ;
            if (file_exists('backend/img/user_photo'.$prev_photo_name)) {
        ...
        if (!empty($request->identification_photo_edit)) {
            ...
            $user->update();
            // ;
            if (file_exists('backend/img/id_photo'.$prev_identification_photo_name)) {
        ...
        $user->forceFill([
            ...
            'nick_name' => $request->nick_name_edit,
            'dob' => $new_dob_edit,
