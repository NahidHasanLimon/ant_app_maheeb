                    ...
                    <div style="border: none" class="card">
                        <div class="card-title">
                            <div class="preview"><i class="" aria-hidden="true"></i>
                                <h5 class="text-center font-weight-bolder" id="">Add New Brand</h5>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form method="post" name="add_holiday_form" id="add_holiday_form">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label for="department_name">Brand</label>
                                                <input id="brandId" class="form-control" name="lead_brand_name" type="text"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <h5 class="text-center font-weight-bolder" id="">Edit Brand</h5>
            ...
            <div style="border: none; border-radius:25px " class="card">
                ...
                <div style="position: relative" class="card-body">
                    ...
                    {{--<button class="vieweditButoon" data-toggle="modal"--}}
                        ...
                        {{--<a href="#" class="">--}}
                            {{--<i class="fa fa-plus my-float"> <span class="btn_txt">Add new Brand</span></i>--}}
                            ...
                            <div id="maheeb" class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="lead_brand_table" class="table holiday_table">
...
@section('pageLevelScript')
    <script type="text/javascript">
        var lead_brand_table = $('#lead_brand_table').DataTable({
        ...
        $('#search_datatable_input').on('keyup', function () {
            lead_brand_table.search(this.value).draw();
        ...
        var config = {
            routes: {
                lead_brand_store: "{!! route('lead-brand.post') !!}",
                lead_brand_delete: "{!! route('lead-brand.delete') !!}",
                lead_brand_detail: "{!! route('lead-brand.detail') !!}",
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success == true) {
                        ...
                        var rowCount = $('#lead_brand_table >tbody >tr').length + 1;

                        lead_brand_table.row.add([

                            '' + data.item.lead_company.lead_company_name   + '',
                            '' + data.item.lead_brand_name  + '',
...
//                 <td>` + data.item.lead_brand_name + ` </td>
//
//
//
// <td>
...
//             </tr>`);
        ...
        $(document).on('click', '.editcompany', function (e) {
            ...
            $.ajax({
                url: config.routes.lead_brand_detail,
                type: "get",
                data: {
                    id: id,
                    type: type,
                ...
                success: function (data) {
                    ...
                    $('#company_edit_form').find('#brandId').val(data.dept.lead_brand_name);
