                            ...
                            <div id="maheeb" class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="lead_industry_table" class="table holiday_table">
                    ...
                    <div style="border: none" class="card">
                        <div class="card-title">
                            <div class="preview"><i class="" aria-hidden="true"></i>
                                <h5 class="text-center font-weight-bolder" id="">Add New Industry</h5>
                            </div>
                        </div>
                                    ...
                                    <form method="post" name="add_holiday_form" id="add_holiday_form">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="company_name" class="form-control" name="lead_industry_name"
                                                       type="text"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <h5 class="text-center font-weight-bolder" id="">Edit Industry</h5>
...
@section('pageLevelScript')
    <script type="text/javascript">
        ...
        var industry_table = $('.holiday_table').DataTable({
            sDom: 'lrtip',
            "paging": false,
            fixedHeader: true
        });
        $('#search_datatable_input').on('keyup', function () {
            industry_table.search(this.value).draw();
        ...
        var config = {
            routes: {
                lead_industry_store: "{!! route('lead-industry.post') !!}",
                lead_industry_delete: "{!! route('lead-industry.delete') !!}",
                lead_industry_detail: "{!! route('lead-industry.detail') !!}",
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success == true) {
                        ...
                        var rowCount = $('#lead_industry_table >tbody >tr').length + 1;


                        industry_table.row.add([

                            '' + data.item.lead_industry_name + '',
...
//
//                 <td>` + data.item.lead_industry_name + ` </td>
//
//
//
// <td>
...
//             </tr>`);
                ...
                error: function (data, errorThrown) {
                    toastr.error("This name has already been taken");
        ...
        $(document).on('click', '.editcompany', function (e) {
            ...
            // console.log(id,si);
            $.ajax({
                url: config.routes.lead_industry_detail,
                type: "get",
                data: {
                    id: id,
                    type: type,
                ...
                success: function (data) {
                    // console.log(data);
                    $('#company_edit_form').find('#company_name').val(data.company.lead_industry_name);
