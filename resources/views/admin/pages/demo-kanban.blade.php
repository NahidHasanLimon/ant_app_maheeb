...
<head>
    ...
    <!-- Font Awesome 5 -->
    <link rel="stylesheet" href="{{asset('backend/libs/@fortawesome/fontawesome-free/css/all.min.css')}}"><!-- Purpose CSS -->
    {{--<link rel="stylesheet" href="../../assets/css/purpose.css" id="stylesheet">--}}
    <link rel="stylesheet" href="{{asset('backend/css/original.css')}}" id="stylesheet">
</head>
...
<div class="container-fluid container-application">
    ...
    <div class="sidenav" id="sidenav-main">
        ...
        <div class="nav-application clearfix">
            ...
            <a href="../../application/task/kanban-board.html" class="btn btn-square text-sm active">
