                                    ...
                                    <form method="post" name="add_project_status_form" id="add_project_status_form">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="pro_status_name_id" class="form-control" name="name"
                                                       type="text"
        ...
        $(document).on('click', '.edit_pro_status', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#project_status_edit_form').find('#catId').val(data.pro_status.status_category.id);
