...
@section('content')
    ...
    <div class="top_text">
        <h1>Manage {{$cat_name->item_category_name}}</h1>
    </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="catId" class="form-control" name="cat_name"
                                                       type="text"   value="{{$cat_name->item_category_name}}"
                                                       readonly disabled>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="sub_cat_id" class="form-control" name="sub_cat_name"
                                                       type="text"
                                                       placeholder="Enter Item Sub Category.." required>
                                            </div>
...
@section('pageLevelScript')
    <script type="text/javascript">
        ...
        var config = {
            routes: {
                sub_cat_store: "{!! route('filtered-item-sub-category.post') !!}",
                sub_cat_delete: "{!! route('project-item-sub-category.delete') !!}",
                sub_cat_detail: "{!! route('filtered-sub-cat.test') !!}",
                sub_cat_update: "{!! route('filtered-item-sub-category.update') !!}",
        ...
        $(document).on('click', '.edit_sub_cat', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    console.log(data);
                    $('#sub_cat_edit_form').find('#catId').val(data.project_category.item_category_name);
