                                    ...
                                    <form method="post" name="add_projects_category_form"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="pr_cat_name_id" class="form-control" name="project_category_name"
                                                       type="text"
...
//             </tr>`);
                        ...
                        project_cat_table.row.add([
                            ...
                            '<button type="button" class="btn edit_btn edit_pr_cat commonbtn" data-toggle="modal" data-id="' + data.item.id +'" data-target="#exampleModal">   <i class="fa fa-pencil"></i>   </button><button type="button" class="btn delete_btn delete_pr_cat commonbtn" data-id="'+ data.item.id +'">   <i class="fa fa-trash"></i>   </button>'
