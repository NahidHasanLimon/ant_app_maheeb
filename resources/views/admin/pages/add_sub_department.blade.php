...
@section('pageLevelScript')
    <script type="text/javascript">
                    ...
                    jQuery.ajax({
                        ...
                        success: function (data) {
                            ...
                            jQuery.each(data, function (key, value) {
                                ...
                                $('select[name="deptName"]').append('<option value="' + value.id + '">' + value.department_name + '</option>');
                            });
                        }
                    });
                } else {
        ...
        $(document).on('submit', '#add_holiday_form', function (event) {
            ...
            $.ajax({
                url: config.routes.sub_dept_store,
                method: "POST",
                ...
                success: function (data) {
                    if (data.success == true) {
                        ...
                        sub_department_table.row.add([

                            ''  + data.item.department.department_name + '',
                            ''  + data.item.sub_department_name +  '',
...
//             </tr>`);
        ...
        $(document).on('click', '.editcompany', function (e) {
            ...
            $.ajax({
                url: config.routes.sub_dept_detail,
                type: "get",
                data: {
                    id: id,
                    type: type,
        ...
        $(document).on('submit', '#company_edit_form', function (e) {
            ...
            $.ajax({
                url: config.routes.sub_dept_update,
                method: "POST",
                data: new FormData(this),
                dataType: 'JSON',
                contentType: false,
