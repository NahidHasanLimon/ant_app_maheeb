...
class CreateLeadProductOrServicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('lead_product_or_services', function (Blueprint $table) {
            $table->increments('id');
            $table->string('lead_product_or_service_name')->nullable();
            $table->tinyInteger('is_lead_product_or_service')->nullable();
            $table->unsignedInteger('lead_sub_industry_id')->nullable();
