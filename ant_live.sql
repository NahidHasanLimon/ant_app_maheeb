...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2020 at 04:50 AM
...
--
-- Dumping data for table `lead_brands`
--

INSERT INTO `lead_brands` (`id`, `lead_brand_name`, `lead_company_id`, `created_at`, `updated_at`) VALUES
(27, 'Lux', 23, '2020-11-25 13:38:33', '2020-11-25 13:38:33'),
(28, 'Meril', 23, '2020-11-25 13:38:40', '2020-11-25 13:38:40'),
(29, 'Mercantile', 24, '2020-11-25 13:39:48', '2020-11-25 13:39:48'),
(30, 'Shonali', 24, '2020-11-25 14:55:05', NULL);
...
(23, 'Uniliver', '2020-11-25 13:38:16', '2020-11-25 13:38:16'),
(24, 'Bank', '2020-11-25 13:38:25', '2020-11-25 13:38:25');
...
(71, '2020_10_18_224032_create_project_item_sub_categories_table', 36),
(72, '2020_11_25_122540_create_new_projects_table', 37);
...
CREATE TABLE `new_projects` (
  `id` int(10) UNSIGNED NOT NULL,
  `lead_brand_id` int(10) UNSIGNED DEFAULT NULL,
  `lead_company_id` int(10) UNSIGNED DEFAULT NULL,
  `projects_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_category_id` int(10) UNSIGNED DEFAULT NULL,
  `status_id` int(10) UNSIGNED DEFAULT NULL,
  `kam_id` int(10) UNSIGNED DEFAULT NULL,
  `work_order_month` date DEFAULT NULL,
  `project_complete_month` date DEFAULT NULL,
  `revenue` int(11) DEFAULT NULL,
  `cost` int(11) DEFAULT NULL,
  `usable_revenue` int(11) DEFAULT NULL,
  `type` int(11) DEFAULT NULL,
  `journal_link` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `new_projects` (`id`, `lead_brand_id`, `lead_company_id`, `projects_name`, `status_category_id`, `status_id`, `kam_id`, `work_order_month`, `project_complete_month`, `revenue`, `cost`, `usable_revenue`, `type`, `journal_link`, `created_at`, `updated_at`) VALUES
(32, 28, 23, 'project_1_updated', 10, 10, 28, '2020-11-25', '2020-11-25', 100, 200, 50, 2, 'test_updated', '2020-11-25 14:46:03', '2020-11-25 14:54:34'),
(33, 28, 23, 'project_3_updated_again_again', 10, 12, 1, '2020-11-27', '2020-11-27', 5000, 200, 120, 2, 'test_tuytuytu', '2020-11-25 14:58:04', '2020-11-25 18:04:57'),
(34, 29, 24, 'project_6_updated_again', 10, 10, 46, '2020-11-27', '2020-12-31', 45, 350, 50, 2, 'test', '2020-11-25 14:58:48', '2020-11-25 19:23:50'),
(35, 30, 24, 'project_10_updated', 10, 10, 50, '2020-11-27', '2020-12-30', 700, 100, 50, 2, 'test_tuytuytu', '2020-11-25 19:24:51', '2020-11-25 19:25:06');
...
INSERT INTO `projects_categories` (`id`, `project_category_name`, `created_at`, `updated_at`) VALUES
(66, 'sdfsdf', '2020-10-18 06:16:25', '2020-10-18 06:16:25');
...
--
-- Dumping data for table `projects_sub_categories`
--

INSERT INTO `projects_sub_categories` (`id`, `projects_sub_category_name`, `project_category_id`, `created_at`, `updated_at`) VALUES
(24, 'test_45', 66, '2020-10-18 06:16:40', '2020-10-18 06:16:40');
...
--
-- Table structure for table `project_item_sub_categories`
--

CREATE TABLE `project_item_sub_categories` (
  `id` int(10) UNSIGNED NOT NULL,
  `item_sub_category_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `item_category_id` int(10) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `project_statuses` (`id`, `name`, `definition`, `project_status_category_id`, `created_at`, `updated_at`) VALUES
(10, 'Running', 'test_1', 10, '2020-11-25 05:28:35', '2020-11-25 05:28:35'),
(11, 'Completed', 'test_2', 10, '2020-11-25 13:17:53', '2020-11-25 13:17:53'),
(12, 'Not Completed', 'test_3', 10, '2020-11-25 13:18:09', '2020-11-25 13:18:09'),
(13, 'Running', 'test_1', 11, '2020-11-25 13:18:42', '2020-11-25 13:18:42'),
(16, 'Completed', NULL, 11, NULL, NULL);
...
--
-- Dumping data for table `project_status_categories`
--

INSERT INTO `project_status_categories` (`id`, `name`, `definition`, `created_at`, `updated_at`) VALUES
(10, 'Bike', 'Yamaha', '2020-10-19 06:38:20', '2020-10-19 06:38:20'),
(11, 'Bank', 'Janata', '2020-11-25 13:18:24', '2020-11-25 13:18:24');
...
INSERT INTO `subscriptions` (`id`, `account_name`, `account_email`, `account_password`, `start_date`, `end_date`, `payment_status`, `module`, `amount`, `created_at`, `updated_at`) VALUES
(13, 'sadsad', 'asdsad@gmail.com', 'asdsad', '2020-11-25', '2020-11-06', 0, 'sadsad', '100', '2020-11-25 11:12:32', '2020-11-25 11:12:32');
...
ALTER TABLE `new_projects`
  ADD PRIMARY KEY (`id`),
  ADD KEY `new_projects_lead_brand_id_foreign` (`lead_brand_id`),
  ADD KEY `new_projects_lead_company_id_foreign` (`lead_company_id`),
  ADD KEY `new_projects_status_category_id_foreign` (`status_category_id`),
  ADD KEY `new_projects_status_id_foreign` (`status_id`),
  ADD KEY `new_projects_kam_id_foreign` (`kam_id`);
...
--
-- Indexes for table `project_item_sub_categories`
--
ALTER TABLE `project_item_sub_categories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `project_item_sub_categories_item_category_id_foreign` (`item_category_id`);
...
--
-- AUTO_INCREMENT for table `project_item_sub_categories`
--
ALTER TABLE `project_item_sub_categories`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- Constraints for table `new_projects`
--
ALTER TABLE `new_projects`
  ADD CONSTRAINT `new_projects_kam_id_foreign` FOREIGN KEY (`kam_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `new_projects_lead_brand_id_foreign` FOREIGN KEY (`lead_brand_id`) REFERENCES `lead_brands` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `new_projects_lead_company_id_foreign` FOREIGN KEY (`lead_company_id`) REFERENCES `lead_companies` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `new_projects_status_category_id_foreign` FOREIGN KEY (`status_category_id`) REFERENCES `project_status_categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `new_projects_status_id_foreign` FOREIGN KEY (`status_id`) REFERENCES `project_statuses` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `project_item_sub_categories`
--
ALTER TABLE `project_item_sub_categories`
  ADD CONSTRAINT `project_item_sub_categories_item_category_id_foreign` FOREIGN KEY (`item_category_id`) REFERENCES `project_item_categories` (`id`) ON DELETE CASCADE;
